                                    ...
                                    <div class="form-group align-middle">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="name" placeholder="Category name"
                                                   value="<?= $category->getName(); ?>" name="name">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-sm-4" for="description">Description:</label>
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" id="description" placeholder="Description" value="<?= $category->getDescription(); ?>" name="description">
                                        </div>
                                    </div>
                                    <div class="form-group">
