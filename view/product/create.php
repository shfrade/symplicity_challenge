                                ...
                                <div class="align-middle">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-12 mt-3">
                                            <img src="<?php echo($product->getImage() ? $product->getImage() : './assets/images/noimage.png') ?>"
                                                 class="card-img" alt="" id="img-image">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text" class="form-control money"
                                                   value="<?= $product->getPrice(); ?>" id="price" placeholder="Price"
                                                   name="price">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                            ...
                                            <select name="category" id="category" class="form-control">
                                                <?php foreach ($categories as $category) : ?>
                                                    <option
                                                        ...
                                                        <?php if ($category->getId() == $product->getCategoryId()) echo 'selected="selected"' ?>
                                                    >
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-offset-2 col-sm-10">
                                            ...
                                            <a href="index.php?product=index">
                                                <button type="button" class="btn btn-danger btn-form">Cancel</button>
                                            </a>
                                        </div>
                                    </div>
                                </div>
